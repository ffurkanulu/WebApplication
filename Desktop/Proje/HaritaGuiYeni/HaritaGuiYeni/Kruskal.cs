...
namespace HaritaGuiYeni
{
	class Kruskal
	{
	//	public List<Edge> resultEdge = new List<Edge>();
		...
		*/
		public Edge[] Kruskall(Graph graph)
		{
		...
		public Edge[] Kruskalmain(int verticesCount, int edgesCount, Edge[] edges)
		{
			Edge[] resultFinal = new Edge[verticesCount];
			Graph graph = CreateGraph(verticesCount, edgesCount);
			graph.edge = edges;
			    resultFinal=  Kruskall(graph);
			return resultFinal;
		}
